    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title">Biodata Mahasiswa - <?= $mahasiswa['nama'] ?></h4>
...
<div class="modal fade" id="modal-edit" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open_multipart('Mahasiswa/UpdateBiodata/' . $mahasiswa['id_mahasiswa']) ?>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h6 class="text-info mb-3">Status Akademik</h6>
                        <div class="mb-3">
                            <label class="form-label">Semester Aktif</label>
                            <select name="semester_aktif" class="form-control">
                                <?php for($i = 1; $i <= 8; $i++): ?>
                                    <option value="<?= $i ?>" <?= $mahasiswa['semester_aktif'] == $i ? 'selected' : '' ?>><?= $i ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="status_akademik" class="form-control">
                                <option value="Aktif" <?= $mahasiswa['status_akademik'] == 'Aktif' ? 'selected' : '' ?>>Aktif</option>
                                <option value="Cuti" <?= $mahasiswa['status_akademik'] == 'Cuti' ? 'selected' : '' ?>>Cuti</option>
                                <option value="Non-Aktif" <?= $mahasiswa['status_akademik'] == 'Non-Aktif' ? 'selected' : '' ?>>Non-Aktif</option>
                                <option value="Lulus" <?= $mahasiswa['status_akademik'] == 'Lulus' ? 'selected' : '' ?>>Lulus</option>
                                <option value="DO" <?= $mahasiswa['status_akademik'] == 'DO' ? 'selected' : '' ?>>DO</option>
                            </select>
                        </div>
                    </div>
                </div>
