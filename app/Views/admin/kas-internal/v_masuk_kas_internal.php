...
<div class="col-md-12">
  <div class="alert bg-light-success alert-dismissible">
    <h5><i class="far fa-money-bill-alt" style="margin-right: 8px;"></i><b>Total <?= $subjudul ?></b></h5>
    <hr>
    <h5>Saldo: <b>Rp. <?= number_format(array_sum($pemasukan), 0) ?></b></h5>
  </div>
</div>
<div class="col-md-12">
          ...
          <tbody>
            ...
            foreach ($kas as $key => $isi_kas) : ?>
              <tr class="text-center">
                <td><b><?= $no++; ?></b></td>
                <td><?= $isi_kas['tgl'] ?></td>
                <td>Rp. <?= number_format($isi_kas['dana_masuk'], 0) ?></td>
                ...
                <td class="text-center">
                  ...
                  <button class="btn btn-danger btn-sm delete-btn" data-id="<?= $isi_kas['id_keuangan'] ?>" data-name="<?= $isi_kas['keterangan'] ?>" data-type="kasinternal-masuk">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-light-success">
        <h4 class="modal-title">Dana Masuk</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?= form_open('KasInternal/InsertDanaMasuk') ?>
        ...
        <div class="form-group">
          <label for="dana_masuk">Jumlah :</label>
          <input type="number" name="dana_masuk" id="dana_masuk" value="0" placeholder="Silahkan isikan jumlah dana masuk" class="form-control" min="1" max="2147483647" required>
        </div>
        <div class="form-group">
  ...
  <div class="modal fade" id="modal-edit<?= $isi_kas['id_keuangan'] ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?= form_open('KasInternal/EditDanaMasuk/' . $isi_kas['id_keuangan']) ?>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="dana_masuk">Jumlah :</label>
            <input type="number" name="dana_masuk" id="dana_masuk" value="<?= $isi_kas['dana_masuk'] ?>" placeholder="Silahkan isikan jumlah dana masuk" class="form-control" min="1" max="2147483647" required>
          </div>
          <div class="form-group">
            <label for="keterangan">Keterangan :</label><br>
