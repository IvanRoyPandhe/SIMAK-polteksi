...
<!-- Header Section -->
<header class="text-white text-center py-5 header-animate" style="background-color: #ff9800;">
  <h1><b>MASJID <?= $tentang['nama_masjid'] ?></b></h1>
  <p class="lead">Mewujudkan Keseimbangan Spiritual dan Sosial</p>
</header>
      ...
      <div class="col-md-4">
        <div class="card border-0 h-100 shadow-sm text-center card-animate card-animate">
          <div class="card-body">
            ...
            <p class="card-text"><?= $tentang['alamat_masjid'] ?></p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
...
<section class="py-5 pt-0">
  <div class="container">
    <h2 class="text-center section-title mt-3">Tentang Masjid</h2>
...
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="text-center section-title">Galeri Masjid</h2>
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100 gallery-animate">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-muted">Tampak luar masjid yang megah</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100 gallery-animate">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-muted">Koleksi Marmer Al-Qur'an</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100 gallery-animate">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-muted">Suasana dalam masjid yang nyaman</p>
          </div>
        </div>
      </div>
    </div>
